...
const AboutMe = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="row">
                {stepsInformation.map((step, index) => <Steps customCss={step.additionalClasses} key={index} stepNumber={step.number} stepTitle={step.stepTitle} stepDescription={step.description} stepLinkText={step.textLink}/> )}
